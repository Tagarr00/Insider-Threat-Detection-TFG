...
print("\n🤖 Entrenando modelo LOF...")
model = LOF(contamination=0.15675)
model.fit(X_final)

labels = model.labels_
scores = model.decision_scores_

model_dir = "model_def/lof"
os.makedirs(model_dir, exist_ok=True)

dump(model, os.path.join(model_dir, "lof_model.joblib"))
...
print(f"Modelo LOF guardado en '{model_dir}'")
